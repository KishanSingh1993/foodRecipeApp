package `in`.eduforyou.foodapp.mvvm

import android.app.Application
import android.util.Log
import androidx.lifecycle.*
import `in`.eduforyou.foodapp.data.db.MealsDatabase
import `in`.eduforyou.foodapp.data.db.Repository
...
import `in`.eduforyou.foodapp.data.retrofit.RetrofitInstance

...
import `in`.eduforyou.foodapp.adapters.FavoriteMealsRecyclerAdapter
...
import `in`.eduforyou.foodapp.ui.fragments.HomeFragment.Companion.MEAL_AREA
import `in`.eduforyou.foodapp.ui.fragments.HomeFragment.Companion.MEAL_ID
import `in`.eduforyou.foodapp.ui.fragments.HomeFragment.Companion.MEAL_NAME
...
import `in`.eduforyou.foodapp.data.pojo.MealDB
import `in`.eduforyou.foodapp.data.pojo.MealDetail
import `in`.eduforyou.foodapp.databinding.FragmentFavoriteMealsBinding

package `in`.eduforyou.foodapp.ui.fragments
...
import `in`.eduforyou.foodapp.adapters.CategoriesRecyclerAdapter
import `in`.eduforyou.foodapp.adapters.MostPopularRecyclerAdapter
import `in`.eduforyou.foodapp.adapters.OnItemClick
import `in`.eduforyou.foodapp.adapters.OnLongItemClick
import `in`.eduforyou.foodapp.data.pojo.Category
...
import `in`.eduforyou.foodapp.databinding.FragmentHomeBinding
import `in`.eduforyou.foodapp.mvvm.DetailsMVVM
import `in`.eduforyou.foodapp.mvvm.MainFragMVVM
import `in`.eduforyou.foodapp.ui.MealBottomDialog
import `in`.eduforyou.foodapp.ui.activites.MealActivity
import `in`.eduforyou.foodapp.ui.activites.MealDetailesActivity
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    companion object{
        const val MEAL_ID="`in`.eduforyou.foodapp.ui.fragments.idMeal"
        const val MEAL_NAME="`in`.eduforyou.foodapp.ui.fragments.nameMeal"
        const val MEAL_THUMB="`in`.eduforyou.foodapp.ui.fragments.thumbMeal"
        const val CATEGORY_NAME="`in`.eduforyou.foodapp.ui.fragments.categoryName"
        const val MEAL_STR=" `in`.eduforyou.foodapp.ui.fragments.strMeal"
        const val MEAL_AREA=" `in`.eduforyou.foodapp.ui.fragments.strArea"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.recViewMealsPopular.visibility = View.GONE
    }
...
//        })
    ...
    private fun showLoadingCase() {
        binding.apply {
            ...
            recViewMealsPopular.visibility = View.GONE
